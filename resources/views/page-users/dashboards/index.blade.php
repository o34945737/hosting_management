<x-layouts.app>
        <x-slot name="toolbar">
            <x-layouts.toolbar title="Dashboard" />
        </x-slot>
                        <!--begin::Row-->
																	...
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Cody Fishers</a>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Brooklyn Simmons</a>
																				<span class="text-gray-400 fw-semibold d-block fs-7">Poland</span>
																			</div>
																		</div>
																	</td>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
																				<span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
																			</div>
																		</div>
																	</td>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Annette Black</a>
																				<span class="text-gray-400 fw-semibold d-block fs-7">Haiti</span>
																			</div>
																		</div>
																	</td>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Marvin McKinney</a>
																				<span class="text-gray-400 fw-semibold d-block fs-7">Monaco</span>
																			</div>
																		</div>
																	</td>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ronald Richards</a>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Leslie Alexander</a>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Courtney Henry</a>
																				<span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
																			</div>
																		</div>
																	</td>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Arlene McCoy</a>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Marvin McKinneyr</a>
																				<span class="text-gray-400 fw-semibold d-block fs-7">Monaco</span>
																			</div>
																		</div>
																	</td>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="../../demo6/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
																				<span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
																			</div>
																		</div>
																	</td>
												...
												<div class="col-sm-6">
													...
													<div class="d-flex flex-column h-100">
															...
															<div class="d-flex align-items-center flex-wrap d-grid gap-2">
																...
																<div class="d-flex align-items-center me-5 me-xl-13">
																	...
																	<div class="m-0">
																		...
																		<a href="../../demo6/dist/pages/user-profile/overview.html" class="fw-bold text-gray-800 text-hover-primary fs-7">Robert Fox</a>
																	</div>
																	<!--end::Info-->
																</div>
																<!--end::Item-->
														...
														<div class="d-flex flex-stack mt-auto bd-highlight">
															...
															<!--end::Users group-->
															<!--begin::Actions-->
															<a href="../../demo6/dist/apps/projects/project.html" class="d-flex align-items-center text-primary opacity-75-hover fs-6 fw-semibold">View Project
